		...
		<tr>
			<td>
				...
				<table width="413">
					...
					%>
					<tr height="1" bgcolor="#dddddd">
						<td colspan="4" width="407"><%=boardbean.getfile()%></td>
					</tr>
					<% }else{ %>
						<tr height="1" bgcolor="#dddddd">
						<td colspan="4" width="407">파일을 업로드하지 않았습니다</td>
					</tr>						
					<% } %>
					...
					<tr align="center">
						...
						<td colspan="2" width="399">
							...
							%> <!-- id 비교부분 넣어야 함  본인이면 수정, 글삭제가 보이게 -->
							<button type="button" onclick="location.href='./updateContext.jsp?context_number=<%=boardbean.getcontext_number()%>'"
							class="btn">수정</button>
							<button type="button" onclick="location.href='./deleteProcess.jsp?context_number=<%=boardbean.getcontext_number()%>'"
							class="btn">글삭제</button> 
							<%
 	}
 %>
